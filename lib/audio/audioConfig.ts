...
export const AUDIO_CONFIG: Record<SceneName, LayerConfig[]> = {
  ...
  library: [
    ...
    { id: 'library-3', src: '/audio/library/layer3.mp3', label: 'Music', prompt: 'soft classical piano music in background, quiet study room instrumental, gentle distant piano' },
    { id: 'library-4', src: '/audio/library/layer4.mp3', label: 'Steps', prompt: 'distant footsteps on hardwood floor, quiet library movement, hushed whispers' },
  ],
  barbershop: [
    { id: 'barbershop-1', src: '/audio/barbershop/layer1.mp3', label: 'Jazz', prompt: 'barbershop jazz radio, old AM radio jazz music, vintage barbershop ambience' },
    { id: 'barbershop-2', src: '/audio/barbershop/layer2.mp3', label: 'Clippers', prompt: 'electric hair clippers buzzing, barbershop clippers sound, hair trimmer ambience', intermittent: { burstDuration: 4, intervalMin: 10, intervalMax: 18, burstGain: 0.8, fadeTime: 0.3 } },
    { id: 'barbershop-3', src: '/audio/barbershop/layer3.mp3', label: 'Chatter', prompt: 'barbershop conversation, customers chatting, friendly barbershop talk' },
  ...
  gym: [
    { id: 'gym-1', src: '/audio/gym/layer1.mp3', label: 'Music', prompt: 'gym workout music, upbeat exercise background music, fitness pump up beats' },
    { id: 'gym-2', src: '/audio/gym/layer2.mp3', label: 'Machines', prompt: 'gym cardio machines, treadmill running sounds, elliptical machine ambience' },
    { id: 'gym-3', src: '/audio/gym/layer3.mp3', label: 'Weights', prompt: 'weight plates clanking, dumbbells dropping, gym weight room sounds', intermittent: { burstDuration: 2, intervalMin: 6, intervalMax: 14, burstGain: 0.85, fadeTime: 0.1 } },
    { id: 'gym-4', src: '/audio/gym/layer4.mp3', label: 'Crowd', prompt: 'gym crowd, people exercising, workout grunts and breathing, fitness room ambience' },
  ],
  tennis: [
  ...
  club: [
    { id: 'club-1', src: '/audio/club/layer1.mp3', label: 'Bass', prompt: 'deep club music bass line, clear powerful sub bass thump, electronic dance music bass' },
    { id: 'club-2', src: '/audio/club/layer2.mp3', label: 'Music', prompt: 'clear electronic dance music, techno club track, crisp DJ set with drums and synths' },
    { id: 'club-3', src: '/audio/club/layer3.mp3', label: 'Crowd', prompt: 'nightclub crowd cheering, people dancing, excited club atmosphere' },
    { id: 'club-4', src: '/audio/club/layer4.mp3', label: 'Drop', prompt: 'music drop at a nightclub, DJ drop moment, crowd eruption at bass drop', intermittent: { burstDuration: 3, intervalMin: 15, intervalMax: 30, burstGain: 0.8, fadeTime: 0.3 } },
  ],
  recordingstudio: [
    { id: 'recordingstudio-1', src: '/audio/recordingstudio/layer1.mp3', label: 'Room', prompt: 'recording studio room tone, quiet studio ambience, professional studio silence hum' },
    { id: 'recordingstudio-2', src: '/audio/recordingstudio/layer2.mp3', label: 'Playback', prompt: 'music playing through studio monitor speakers, muffled music playback, track playing in studio' },
    { id: 'recordingstudio-3', src: '/audio/recordingstudio/layer3.mp3', label: 'Console', prompt: 'mixing console equipment hum, studio equipment sounds, professional audio gear ambience' },
    { id: 'recordingstudio-4', src: '/audio/recordingstudio/layer4.mp3', label: 'Take', prompt: 'musician recording a take, acoustic guitar or piano being recorded, studio session sounds', intermittent: { burstDuration: 5, intervalMin: 18, intervalMax: 35, burstGain: 0.75, fadeTime: 0.4 } },
  ],
}
